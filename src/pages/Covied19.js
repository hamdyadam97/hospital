...
class Covied19 extends React.Component{
    render(){
        return(
        <>
      ...
      <div class="container">
        <img src="assets/imgs/work-steps3.png" alt="" class="image" />
        <div class="info">
          <div class="box">
            <img src="imgs/work-steps-1.png" alt="" />
            <div class="text">
              <h3>Keep yourself and others safe</h3>
              <p>
          ...
          <div class="box">
            ...
            <div class="text">
              ...
              <p>
              Make sure your mask covers your nose, mouth and chin,Don’t use masks with valves.
              </p>
            </div>
          </div>
          <div class="box">
    ...
    <div class="work-steps" id="work-steps">
      <div class="container">
        <img src="assets/imgs/work-steps4.png" alt="" class="image" />
        <div class="info">
          <div class="box">
            <img src="imgs/work-steps-1.png" alt="" />
            <div class="text">
              <h3>Keep good hygiene</h3>
              <p>
