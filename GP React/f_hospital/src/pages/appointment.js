...
function Appointment() {
    ...
    useEffect(() => {
        axios.get(`http://127.0.0.1:8000/appointment/historyofdoctor/${namedata}`)
    ...
    const Cancel = (ID) => {
        ...
        axios.get(`http://127.0.0.1:8000/appointment/cancel_appointment/${ID}`)
    ...
    const Done = (ID) => {
        ...
        axios.get(`http://127.0.0.1:8000/appointment/done_appointment/${ID}`)
